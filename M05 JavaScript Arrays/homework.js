...
function diaDeLaSemana(numeroDeDia) {
   ...
   if (numeroDeDia === 1 || numeroDeDia === 7) {
      return "Es fin de semana"; // Si es Domingo (1) o Sábado (7)
    } else if (numeroDeDia >= 2 && numeroDeDia <= 6) {
      return "Es dia laboral"; // Si es Lunes (2) hasta Viernes (6)
    } else {
      return "Número de día inválido"; // En caso de un número fuera del rango 1-7
    }
}
...
function mesesDelAño(array) {
   ...
   // Tu código:
   const mesesPedidos = []; // Creamos un arreglo vacío para almacenar los meses encontrados.
...
function continueStatement(num) {
   ...
   // Tu código:
   const resultados = []; // Creamos un arreglo para almacenar los nuevos valores.
